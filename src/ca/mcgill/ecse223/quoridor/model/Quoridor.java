...
public class Quoridor
{
  ...
  public Game addGame(String aWinner, boolean aGameOver, boolean aTurn, Clock aClock, Board aBoard, PositionFile aPositionFile)
  {
    return new Game(aWinner, aGameOver, aTurn, aClock, aBoard, aPositionFile, this);
  }
